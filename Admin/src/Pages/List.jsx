...
const List = ({ token }) => {
    ...
    return (
        ...
        {loading && <Loader></Loader>}
           <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2 ml-10">
           <p className='font-semibold'>All Products</p>
           <p className='font-semibold'>{list.length} Items</p>
           </div>
            <div className='flex flex-col gap-2'>
                {/* List Table Title */}
                <div className='hidden md:grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-1 px-2 border border-gray-300 bg-gray-100 text-sm ml-10'>
                    <b>Image</b>
                    <b>Name</b>
                    <b>Category</b>
                    <b>Price</b>
                ...
                {/* Product List */}
                {
                    list.length === 0 ? <div className='justify-center'>
                        ...
                        <div key={index} className='grid grid-[1fr_3fr_1fr] md:grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center gap-2 py-1 px-2 border text-sm ml-10 border-gray-300'>
